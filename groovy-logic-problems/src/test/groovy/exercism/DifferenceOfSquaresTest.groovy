...
class DifferenceOfSquaresTest extends Specification {

    void "Testing difference of square of ten first numbers"() {
        given: "Number"
        BigInteger num = 10
        BigInteger response = 2640

        when: "Testing"
        DifferenceOfSquares clazz = new DifferenceOfSquares(num)
        BigInteger result = clazz.difference()
